...
struct DexDataMap {
    dex_u4 count;    /* number of items currently in the map */
    dex_u4 max;      /* maximum number of items that may be held */
    dex_u4* offsets; /* array of item offsets */
    dex_u2* types;   /* corresponding array of item types */
};
