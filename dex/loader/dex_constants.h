...
enum class DexTypeCodes {
       Header       = 0x0000, StringId             = 0x0001, TypeId               = 0x0002, ProtoId       = 0x0003, FieldId    = 0x0004,
...
ENUM_FLAGS_OPERATORS(DexAccessFlags)
ENUM_FLAGS_OPERATORS(DexValueFormats)
ENUM_FLAGS_OPERATORS(DexTypeCodes)
